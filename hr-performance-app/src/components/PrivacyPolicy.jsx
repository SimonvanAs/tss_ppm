  ...
  const content = {
    ...
    nl: {
      ...
      sections: [
        ...
        {
          title: '10. Disclaimer en beperking van aansprakelijkheid',
    ...
    es: {
      ...
      sections: [
        ...
        {
          title: '10. Descargo de responsabilidad y limitación de responsabilidad',
